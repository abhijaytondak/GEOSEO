...
const DESCRIPTION =
  "About Citensity — the platform that helps brands get found in Google search AND cited by AI answer engines like ChatGPT, Perplexity, and Google AI Overviews.";
...
export default function AboutPage() {
  return (
    <LegalPage
      title="About Citensity"
      kicker="Company"
      path="/about"
      intro="Citensity helps brands get found where buyers now look — in Google search and in AI answers from ChatGPT, Perplexity, and Google AI Overviews. We turn your real business facts into content that ranks, gets cited, and converts."
      sections={[
        {
          ...
          body: (
            <>
              ...
              <p>
                Citensity exists to make brands visible in both worlds at once: traditional SEO for Google, and
        ...
        },
        {
          ...
          body: (
            <p>
              We are deliberately anti-spam. Citensity grounds content in your Brand Memory and refuses to fabricate
        ...
        },
        {
          ...
          body: (
            <p>
              ...
              Citensity can do for your brand, start with a{" "}
