...
const AI_SEARCH: SolutionCapability[] = [
  ...
  { label: "CMS publishing adapters", status: "gap", note: "WordPress REST publish seam wired + verified (env-gated WORDPRESS_BASE_URL/USERNAME/APP_PASSWORD); publishing a page pushes to WordPress + records the live URL the moment creds are set. Webflow/Shopify next; no live push without a token yet." },
